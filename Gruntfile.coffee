module.exports = (grunt) ->
	...
	grunt.registerTask 'dev', ['less:dev', 'coffee', 'copy:coffee', 'copy:video', 'svg_sprite','responsive_images', 'hugo:dev']
	grunt.registerTask 'default', ['less:dist', 'coffee', 'copy:coffee', 'copy:video', 'uglify','svg_sprite', 'responsive_images','hugo:dist']
